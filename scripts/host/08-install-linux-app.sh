...
Builds the release binary and installs the Linux app integration for this user:
  ...
  - ~/.local/share/applications/dev.winbridge.KakaoTalk.desktop
  - ~/.local/share/icons/hicolor/256x256/apps/winbridge-kakaotalk.png
  - ~/.local/bin/kakaotalk
  - ~/.config/autostart/dev.winbridge.KakaoTalk.desktop
...
log_info "  launcher: ~/.local/share/applications/dev.winbridge.KakaoTalk.desktop"
log_info "  autostart: ~/.config/autostart/dev.winbridge.KakaoTalk.desktop"
log_info "You can now launch KakaoTalk from the app icon even when the VM is off."
